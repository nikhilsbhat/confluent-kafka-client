...
APP_NAME?=confluent-kafka-client
...
BUILD_WITH_FLAGS="-s -w -X 'github.com/nikhilsbhat/confluent-kafka-client/Version=${VERSION}' -X 'github.com/nikhilsbhat/confluent-kafka-client/Env=${BUILD_ENVIRONMENT}' -X 'github.com/nikhilsbhat/confluent-kafka-client/BuildDate=${DATE}' -X 'github.com/nikhilsbhat/confluent-kafka-client/Revision=${REVISION}' -X 'github.com/nikhilsbhat/confluent-kafka-client/Platform=${PlATFORM}/${ARCHITECTURE}' -X 'github.com/nikhilsbhat/confluent-kafka-client/GoVersion=${GOVERSION}'"
...
build:
	go build -o ${APP_NAME} ${BUILD_WITH_FLAGS}
